...
if 'lancamentos' not in st.session_state:
    st.session_state.lancamentos = pd.DataFrame([
        ...
        {"Data": "2026-08-10", "Descrição": "Fatura Sam's Club", "Valor (R$)": 450.00, "Tipo": "Saída", "Forma": "Cartão Sam's Club", "Categoria": "Cartão de Crédito"},
        {"Data": "2026-08-10", "Descrição": "Fatura Mercado Pago", "Valor (R$)": 530.00, "Tipo": "Saída", "Forma": "Cartão Mercado Pago", "Categoria": "Cartão de Crédito"},
        {"Data": "2026-08-10", "Descrição": "Fatura Amazon", "Valor (R$)": 380.00, "Tipo": "Saída", "Forma": "Cartão Amazon", "Categoria": "Cartão de Crédito"},
        {"Data": "2026-08-10", "Descrição": "Outros Cartões", "Valor (R$)": 375.75, "Tipo": "Saída", "Forma": "Outros Cartões", "Categoria": "Cartão de Crédito"}
    ])
